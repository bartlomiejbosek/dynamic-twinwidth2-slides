...
{\footnotesize Take the final canonical slab decomposition from slide~9 as the last rebuilt base stored in $\mathbb{P}$; all newer updates are kept only symbolically in $\mathbb{Q}$.}
...
\node[font=\scriptsize\bfseries] at (2,4.85) {base canonical slabs in $\mathbb{P}$};
\fillslab{slab1}{2}{2}{1}{1}{4}
\fillslab{slab2}{4}{4}{1}{1}{4}
\fillslab{slab4}{2}{4}{2}{3}{4}
\fillslab{slab5}{1}{1}{4}{4}{4}
...
\drawslab{slab5}{1}{1}{4}{4}{4}
\drawslab{slab3}{3}{4}{4}{4}{4}
\draw[updatezero,line width=1.1pt,rounded corners=1pt] (1,2) rectangle (2,3);
\draw[updateone,line width=1.1pt,rounded corners=1pt] (3,2) rectangle (4,3);
\node[draw,rounded corners,fill=gray!6,align=left,font=\scriptsize,anchor=north west] at (4.55,3.95) {$\mathbb{Q}$ keeps only overrides\\[3pt]
\tikz{\draw[updatezero,line width=1pt,rounded corners=1pt] (0,0) rectangle (0.22,0.22);}~buffered $0$\\[2pt]
\tikz{\draw[updateone,line width=1pt,rounded corners=1pt] (0,0) rectangle (0.22,0.22);}~buffered $1$};
\end{tikzpicture}

\smallskip
{\tiny\color{gray} New schematic based directly on Theorem~4; base picture reused from Figure~5.}
\end{column}
\begin{column}{0.54\textwidth}
{\small \textbf{$\mathbb{P}$:} static 2D orthogonal point location on the canonical slab decomposition stored at the last rebuild.}

\medskip
{\small \textbf{$\mathbb{Q}$:} dictionary of explicit cell values for the updates buffered since that rebuild.}
...
\medskip
{\scriptsize $\mathtt{QueryBit}(i,j)$ first checks $\mathbb{Q}$ and asks $\mathbb{P}$ on a miss. \;
$\mathtt{Update}(i,j)$ stores the newest explicit value in $\mathbb{Q}$; on first touch it queries $\mathbb{P}$ to recover the old value. When $|\mathbb{Q}|=8f_d(n+2)$, rebuild the base decomposition and empty the buffer.}

{\tiny\color{gray} Theorem~4: $\Oh(\log\log n)$ expected worst-case queries and $\Oh(\log\log n)$ expected amortized updates.}
\end{frame}

%% ============== SLIDE 11: Rebuilding ==============
\begin{frame}{Rebuilding $\mathbb{P}$: 0-updates split slabs, uncovered 1-updates become $1\!\times\!1$ slabs}

{\scriptsize Rebuilding starts from slabs $\mathcal{P}$ extracted from $\mathbb{P}$ and explicit updates $\mathcal{Q}$ extracted from $\mathbb{Q}$.}
...
\item Assign 0-updates to slabs of $\mathcal{P}$
\item Split each affected slab row-by-row; keep untouched pieces
\item Every uncovered 1-update becomes a $1\!\times\!1$ slab
\end{enumerate}

\smallskip
{\scriptsize The resulting family $\mathcal{K}$ is already a slab decomposition of the current matrix, with $|\mathcal{K}| \leq |\mathcal{P}|+2|\mathcal{Q}|$.}

{\scriptsize Then run $\mathtt{Decompose}(n,\mathcal{K})$ to get the new canonical decomposition.}
\end{column}
\begin{column}{0.49\textwidth}
\centering
\begin{tikzpicture}[scale=0.29,font=\scriptsize]
\node[font=\tiny\bfseries] at (2.5,5.05) {old $\mathbb{P}$ + new $\mathbb{Q}$};
\fillslab{slab5}{3}{5}{1}{2}{5}
\fillslab{slab4}{3}{4}{3}{3}{5}
\fillslab{slab1}{4}{5}{4}{5}{5}
\draw[step=1,gray!45] (0,0) grid (5,5);
\draw[thick] (0,0) rectangle (5,5);
\drawslab{slab5}{3}{5}{1}{2}{5}
\drawslab{slab4}{3}{4}{3}{3}{5}
\drawslab{slab1}{4}{5}{4}{5}{5}
\draw[updatezero,line width=1.1pt,rounded corners=1pt] (2,2) rectangle (3,3);
\draw[updatezero,line width=1.1pt,rounded corners=1pt] (3,1) rectangle (4,2);
\draw[updateone,line width=1.1pt,rounded corners=1pt] (4,2) rectangle (5,3);
\node[font=\tiny,align=center,anchor=north] at (2.5,-0.1) {base + overrides};

\draw[-{Stealth[length=5pt]},very thick] (5.25,2.45)--(5.85,2.45);

\begin{scope}[shift={(6.15,0)}]
\node[font=\tiny\bfseries] at (2.5,5.05) {build $\mathcal{K}$};
\fillslab{slab5}{3}{5}{1}{2}{5}
\fillslab{slab4}{3}{3}{3}{3}{5}
\fillslab{splitpiece}{4}{4}{3}{3}{5}
\fillslab{slab1}{4}{5}{4}{5}{5}
\fillslab{updateone!35}{3}{3}{5}{5}{5}
\draw[step=1,gray!45] (0,0) grid (5,5);
\draw[thick] (0,0) rectangle (5,5);
\drawslab{slab5}{3}{5}{1}{2}{5}
\drawslab{slab4}{3}{3}{3}{3}{5}
\drawslab{splitpiece}{4}{4}{3}{3}{5}
\drawslab{slab1}{4}{5}{4}{5}{5}
\draw[updateone,line width=1.1pt,rounded corners=1pt] (4,2) rectangle (5,3);
\node[font=\tiny,align=center,anchor=north] at (2.5,-0.1) {split + uncovered $1\times 1$};
\end{scope}

\draw[-{Stealth[length=5pt]},very thick] (11.4,2.45)--(11.95,2.45);

\begin{scope}[shift={(12.3,0.15)}]
\draw[rounded corners,fill=gray!5] (0,0.3) rectangle (2.55,4.35);
\node[font=\tiny\bfseries,align=center] at (1.275,3.85) {$\mathtt{Decompose}$};
\fill[gray!10] (0.45,1.0) rectangle (2.05,3.1);
\draw[gray!35,step=0.4] (0.45,1.0) grid (2.05,3.1);
\draw[thick,gray!55] (0.45,1.0) rectangle (2.05,3.1);
\fill[slab5!35] (0.45,1.0) rectangle (0.85,3.1);
\fill[slab4!35] (0.85,1.4) rectangle (1.25,2.6);
\fill[slab1!32] (1.25,1.0) rectangle (2.05,1.8);
\draw[slab5!80!black,very thick] (0.45,1.0) rectangle (0.85,3.1);
\draw[slab4!80!black,very thick] (0.85,1.4) rectangle (1.25,2.6);
\draw[slab1!80!black,very thick] (1.25,1.0) rectangle (2.05,1.8);
\node[font=\tiny,align=center] at (1.275,0.62) {new canonical slabs};
\end{scope}
\end{tikzpicture}
...
\item During $E_{2i-1}$: the next structure catches up by processing two updates while the previous one processes one
\item Queries keep going to the currently active copy throughout
\end{itemize}

\medskip
{\footnotesize Two copies are needed: $\mathbb{A}_{i,0}$ is the active structure, while $\mathbb{A}_{i,1}$ is the frozen snapshot that gives uninterrupted access to the old state during initialization.}

\medskip
\centering
\begin{tikzpicture}[x=0.95cm,y=0.74cm,font=\small]
\draw[thick,-{Stealth[length=5pt]}] (0,0)--(7.6,0);
\node[font=\tiny,gray] at (0.35,0.2) {$\cdots$};
\node[font=\tiny,gray] at (7.1,0.2) {$\cdots$};
\fill[darkblue!8] (1.0,-0.02) rectangle (3.9,0.52);
\fill[darkblue!16] (3.9,-0.02) rectangle (6.6,0.52);
\node[font=\scriptsize] at (2.45,0.24) {$E_{2i-2}$};
\node[font=\scriptsize] at (5.25,0.24) {$E_{2i-1}$};

\node[left,font=\scriptsize,darkblue,align=right] at (0.9,1.75) {active copy\\answering updates};
\node[left,font=\scriptsize,darkred,align=right] at (0.9,0.9) {next copy\\being prepared};
\draw[thick,darkblue] (1.0,1.75)--(6.55,1.75);
\node[font=\tiny,darkblue,above] at (3.8,1.78) {$\mathbb{A}_{i,0}$ keeps answering queries};
\draw[thick,darkred] (1.0,0.9)--(6.55,0.9);

\node[draw,rounded corners,fill=gray!8,font=\tiny,align=center] (snap) at (1.45,2.45) {read-only snapshot\\$\mathbb{A}_{i,1}$};
\draw[gray!70,-{Stealth[length=4pt]}] (snap.south)--(1.45,1.02);

\fill[slab4!55] (1.0,0.72) rectangle (3.9,1.08);
\node[font=\tiny,darkred] at (2.45,0.48) {background Init from frozen snapshot};

\fill[slab3!45] (3.9,0.72) rectangle (6.55,1.08);
\foreach \x in {4.35,4.95,5.55,6.15} {
  \draw[darkred,-{Stealth[length=4pt]},line width=0.9pt] (\x,0.78)--++(0.18,0.18);
  \draw[darkred,-{Stealth[length=4pt]},line width=0.9pt] (\x,0.92)--++(0.18,0.18);
}
\node[font=\tiny,darkred] at (5.2,0.48) {catch-up: 2 updates here / 1 above};

\draw[-{Stealth[length=6pt]},very thick,darkred] (6.55,0.9)--(6.95,1.75);
\node[font=\tiny,darkred,right] at (6.98,1.36) {takes over};
\end{tikzpicture}

\smallskip
{\footnotesize\color{gray} New timeline schematic based on Theorem~5; no literal update sequence shown.}
\end{frame}
